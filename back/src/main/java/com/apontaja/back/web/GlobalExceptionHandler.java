...
/**
 * Filet de sécurité générique, sans dépendance à un domaine métier
 * particulier — les exceptions métier spécifiques restent gérées localement
 * dans chaque contrôleur (ex. RegisterController.handleEmailAlreadyUsed).
 * Ferme le bug historique "message d'exception brut renvoyé au client"
