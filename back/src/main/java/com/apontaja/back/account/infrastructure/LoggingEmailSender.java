...
/**
 * Mock v1 : logue le contenu au lieu d'envoyer un vrai email. À remplacer
 * par un vrai provider (SMTP/Postmark/etc.) quand l'hébergement de
 * production sera choisi (§6 [OPEN] du contexte).
 */
@Component
